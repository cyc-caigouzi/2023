...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,  default='Tide',
                        help='model name, options: [Transformer, Linear, NLinear, DLinear, SCINet, ConvFC, MTSMixer, MTSMatrix, FNet, Tide]')

    # data loader
    parser.add_argument('--data', type=str,  default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='/MTS-Mixers/Tide/MTS-Mixers-main/data_provider', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='gfdf_with_cloud.csv', help='data file')
    ...
    # forecasting task
    parser.add_argument('--L', type=int, default=24*4*14, help='Lookback')
    parser.add_argument('--label_len', type=int, default=48, help='start token length')
    parser.add_argument('--H', type=int, default=96, help='prediction sequence length')
    parser.add_argument('--r', type=int, default=12, help='the number of covariates for each series')
    parser.add_argument('--r_hat', type=int, default=5, help='temporalWidth in the paper, i.e., \hat{r} << r')
    parser.add_argument('--p', type=int, default=4, help='decoderOutputDim in the paper')
    parser.add_argument('--hidden_dim', type=int, default=1024, help='hiddenSize in the paper')
    parser.add_argument('--encoder_layer_num', type=int, default=3)
    parser.add_argument('--decoder_layer_num', type=int, default=1)
    parser.add_argument('--featureProjectionHidden', type=int, default=2)
    parser.add_argument('--temporalDecoderHidden', type=int, default=64)
    ...
    parser.add_argument('--norm', action='store_false', default=False, help='whether to apply LayerNorm')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_Batchsize{}_ft{}_pl{}_lb{}_r{}_rhat{}_p{}_hd{}_'.format(
                args.model,
                args.data_path[:-4],
                args.batch_size,
                args.features,
